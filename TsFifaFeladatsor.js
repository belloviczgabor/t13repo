...
function CsapatokMennyisege(vizsgaltTomb) {
...
function AtlagFelettiek(vizsgaltTomb) {
    var atlagPont = PontszamokAtlaga(vizsgaltTomb);
    var atlagFelettiek = [];
    for (var i = 0; i < vizsgaltTomb.length; i++) {
...
function LegtobbetJavitoCsapatIndex(vizsgaltTomb) {
...
function LegtobbetJavitoCsapatIndexKiir(csapatIndex) {
